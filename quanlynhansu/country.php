...
<ol class="breadcrumb" style="margin: 10px 0px ! important;">
    <li class="breadcrumb-item"><a href="Home.php">Trang chủ</a><i class="fa fa-angle-right"></i>Quản lý<i class="fa fa-angle-right"></i>Quốc gia</li>
</ol>
        ...
        <h2>Thêm quốc gia</h2>
            ...
            <div class="col-md-3 control-label">
              <label class="control-label">Quốc gia</label>
                ...
                <input type="text" name="country" required="" value="<?php echo $cid; ?>" placeholder="Tên quốc gia" class="form-control" style="width: 250px; height: 35px; float: right;">
                </div>
            </div>
              <div class="clearfix"> </div>
        </div>
            <div class="col-md-12 form-group">
              <button type="submit" name="countryy" class="btn btn-primary">Thêm</button>
              <button type="button" onclick="location.href = 'country.php'" class="btn btn-default">Làm mới</button>
    ...
    <div style="height: 396px;">
          <div class="w3l-table-info">
            ...
            <form method="GET" action="#">
              ...
              <input style="float: right;" placeholder="Tìm kiếm..." type="search-box" name="searccountry" value="<?php echo(isset($_GET['searccountry']))?$_GET['searccountry']:"";?>"><br>
            </form>
              <table id="table">
            <thead>
              <tr>
                <th>Id</th>
              <th style="width: 5000px;">Tên</th>
              <th style="text-align: center; width: 450px;">Hành động</th>
              </tr>
            </thead>
            <tbody>
