...
<ol class="breadcrumb" style="margin: 10px 0px ! important;">
    <li class="breadcrumb-item"><a href="Home.php">Trang chủ</a><i class="fa fa-angle-right"></i>Nhân viên<i class="fa fa-angle-right"></i> Thời gian đăng xuất đã sửa đổi</li>
</ol>
<form method="POST">
<div class="container-fluid" style="margin-bottom: 30px;margin-top: 10px; background: white;">
  <div class="row" style="margin-left: 0; margin-right: 0;">
    <h2 style="color: #1abc9c;">Thời gian đăng xuất đã thay đổi</h2><hr>
    <div class="col-md-5 control-label">
        ...
        <div class="input-group">             
            ...
            <select name="leavestatus" title="Chọn đơn nghỉ" style="text-transform: capitalize; " required>
    ...
    <div class="row" style="margin-left: 0; margin-right: 0;">
        <div class="col-md-5 control-label">
            <label class="control-label">Ngày đăng xuất</label>
            <div class="input-group">             
                <span class="input-group-addon">
    ...
    <div class="row" style="margin-left: 0; margin-right: 0;">
      <div class="col-md-3 form-group">
          <button type="submit" name="modifiedlogout" title="Thêm" class="btn btn-primary">Thêm</button>
            <button type="reset" class="btn btn-default" title="Làm mới">Làm mới</button>
        </div>
        <div class="clearfix"> </div>
    </div>
</div>
