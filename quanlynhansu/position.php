...
<ol class="breadcrumb" style="margin: 10px 0px ! important;">
    <li class="breadcrumb-item"><a href="Home.php">Trang chủ</a><i class="fa fa-angle-right"></i>Quản lý<i class="fa fa-angle-right"></i>Chức vụ</li>
</ol>
        ...
        <h2>Thêm chức vụ</h2>
          	<div class="col-md-3 control-label">
            	<label class="control-label">Chức vụ</label>
              	...
              	<input type="text" name="position" required="" value="<?php echo $name; ?>"  placeholder="Tên chức vụ" class="form-control" style="width: 250px; height: 35px; float: right;">
              	</div>
            </div>
            	<div class="clearfix"> </div>
        </div>
            <div class="col-md-12 form-group">
              <button type="submit" name="positionl" class="btn btn-primary">Thêm</button>
