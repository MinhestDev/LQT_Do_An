...
<ol class="breadcrumb" style="margin: 10px 0px ! important;">
    <li class="breadcrumb-item"><a href="Home.php">Trang chủ</a><i class="fa fa-angle-right"></i>Đơn nghỉ<i class="fa fa-angle-right"></i>Đơn nghỉ</li>
</ol>
<form method="POST">
<div class="validation-form">
  <h2>Yêu cầu đơn nghỉ</h2>
