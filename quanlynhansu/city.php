...
<ol class="breadcrumb" style="margin: 10px 0px ! important;">
    <li class="breadcrumb-item"><a href="Home.php">Trang chủ</a><i class="fa fa-angle-right"></i>Quản lý<i class="fa fa-angle-right"></i>Thành phố</li>
</ol>
            ...
            <div class="clearfix"> </div>
          	...
          	<div class="col-md-3 control-label">
            	<label class="control-label">Thành phố</label>
              	...
              	<input type="text" name="city" placeholder="Tên thành phố" value="<?php echo $name; ?>" required="" class="form-control" style="width: 250px; height: 35px;">
              	</div>
            </div>
            	<div class="clearfix"> </div>
        </div>
            <div class="col-md-12 form-group">
              <button type="submit" name="cityy" class="btn btn-primary">Thêm</button>
