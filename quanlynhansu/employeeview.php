...
<ol class="breadcrumb" style="margin: 10px 0px ! important;">
    <li class="breadcrumb-item"><a href="Home.php">Trang chủ</a><i class="fa fa-angle-right"></i>Nhân viên<i class="fa fa-angle-right"></i>Xem nhân viên</li>
</ol>
 	...
 	<div>
		...
		<br>
	  	<form method="GET" action="#">
			...
			<input style="float: right;" placeholder="Tìm kiếm" value="<?php echo(isset($SearchName))?$SearchName:''; ?>" type="search-box" name="search"><br>
		</form>
		<table id="table">
		<thead>
			<tr>
				<th style="text-transform: capitalize;">Ảnh trang cá nhân</th>
				<th style="text-transform: capitalize;">Tên</th>
				<th style="text-transform: capitalize; text-align: center;">ID nhân viên</th>
				<th style="text-transform: capitalize; text-align: center;">Chi tiết đầy đủ</th>
			</tr>
		</thead>
		<tbody>
		<?php while($row = mysqli_fetch_assoc($sql)) { ?>
			<tr>
				...
				<td style="text-align: center;"><a href="detailview.php?employeeid=<?php echo $row['EmpId'];?>"><u>Xem</u></a></td>
			</tr>
		<?php }?>
		</tbody>
		</table>
