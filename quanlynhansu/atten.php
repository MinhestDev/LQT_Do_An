...
<ol class="breadcrumb" style="margin: 10px 0px ! important;">
    <li class="breadcrumb-item"><a href="Home.php">Trang chủ</a><i class="fa fa-angle-right"></i>Nghỉ phép<i class="fa fa-angle-right"></i>Attendece View</li>
</ol>
<form method="post">
<div class="validation-form" style="margin-bottom: 30px;">
	<h2 style="color: #1abc9c;">Chế độ xem</h2>
	<div class="row" style="margin-bottom: 10px;">
		<div class="col-md-2">
			<select id="sortby" name="by" style="text-transform: capitalize;" onchange="sortbychange();" onclick="sortbychange();">
				<option value="1" <?php if($SelectedSortById==1){echo "selected";} ?>>Bởi tất cả</option>
				<option value="2" <?php if($SelectedSortById==2){echo "selected";} ?>>Bởi tháng</option>
				<option value="3" <?php if($SelectedSortById==3){echo "selected";} ?>>Bởi năm</option>
			</select>
		</div>
		<div class="col-md-2">
		...
		<div class="col-md-1">
			<button type="submit" style="display: none;" id="add" name="yearss" class="btn btn-primary">Gửi</button>
		</div>
