...
?>
<title><?= $page_title ?>Hệ thống quản lý nhân sự</title>
               ...
               <!--header start here-->
				<div class="header-main">
					<div style="padding: 1.15em; margin-right: 0%; width: 70%;" class="logo-w3-agile">
						<h1 clas><a href="index.php">Hệ thống quản lý nhân sự</a></h1>
					</div>
								...
								<ul>
									<li class="dropdown profile_details_drop">
										...
										<ul class="dropdown-menu drp-mnu">
											<li> <a href="profile.php"><i class="fa fa-user"></i> Trang cá nhân</a> </li> 
											<li> <a href="controller/logout.php"><i class="fa fa-sign-out"></i> Đăng xuất</a> </li>
										</ul>
									</li>
								</ul>
							</div>
