...
<ol class="breadcrumb" style="margin: 10px 0px ! important;">
    <li class="breadcrumb-item"><a href="Home.php">Trang chủ</a><i class="fa fa-angle-right"></i>Quản lý<i class="fa fa-angle-right"></i>Tỉnh</li>
</ol>
        	...
        	<div class="col-md-3 control-label">
          	...
          	<div class="col-md-3 control-label">
            	<label class="control-label">Tỉnh</label>
              	...
              	<input type="text" name="state" required="" value="<?php echo $name; ?>" placeholder="Tên tỉnh" class="form-control" style="width: 250px; height: 35px; float: right;">
              	</div>
            </div>
            	<div class="clearfix"> </div>
        </div>
            <div class="col-md-12 form-group">
              <button type="submit" name="addstates" class="btn btn-primary">Thêm</button>
 		...
 		<div style="height: 396px;">
					<div class="w3l-table-info">
					  ...
					  <form method="GET" action="#">
					  	...
					  	<input style="float: right;" placeholder="Tìm kiếm..." type="search-box" name="searcstate" value="<?php echo(isset($_GET['searcstate']))?$_GET['searcstate']:"";?>"><br>
					  </form>
					    <table id="table">
						<thead>
						  <tr>
