...
<body>
    ...
    <h1 class="text-white">Hệ Thống Quản Lý Nhân Sự | Nhân sự</h1>
    <br>
    <br>
<div class="login-block">
    <h1>Đăng nhập</h1>
    <form class="form" method="POST" Action="../controller/login.php">
    <input type="text" name="name" value="" placeholder="Email" id="username" />
    <input type="password" name="password" value="" placeholder="Mật khẩu" id="password" />
    <h4 style="color: #FF0000; font-weight: normal;"><?php echo $result; ?></h3>
    <button type="submit" name="clientlogin">Gửi</button>
    </form>
</div>
</body>
