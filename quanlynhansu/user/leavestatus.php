...
?>
            <div class="s-12 l-10">
               <h1 style="color: #858282;">Đơn xin nghỉ phép</h1><hr>
               <div class="clearfix"></div>
               	...
               	<div class="s-12 l-2">
               		<h4 style="background: #858282; color: white; text-align: center;">Trạng thái Nghỉ phép</h4>
               	</div>
               	<div class="s-12 l-3">
               		<h4 style="background: #858282; color: white; text-align: center;">Lý do</h4>
               	</div>
               	<div class="s-12 l-2">
               		<h4 style="background: #858282; color: white; text-align: center;">Ngày bắt đầu</h4>
               	</div>
               	<div class="s-12 l-2">
               		<h4 style="background: #858282; color: white; text-align: center;">Ngày kết thúc</h4>
               	</div>
               	<div class="s-12 l-1">
               		<h4 style="background: #858282; color: white; text-align: center;">Trạng thái</h4>
               	</div>
               	<div class="s-12 l-1">
               		<h4 style="background: #858282; color: white; text-align: center; border-radius: 0px 4px 4px 0px;">Hành động</h4>
               	</div>
