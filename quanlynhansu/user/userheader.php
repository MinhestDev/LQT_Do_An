   ...
   <body class="size-1140">
      ...
      <header>
         <nav>
            <div class="line">
               <div class="s-12 l-5">
                  <h3 style="color: white;">Hệ thống quản lý nhân sự</h3>
               </div>
               <div class="top-nav s-12 l-3 right">
                  <div class="employee-name" style="margin-top: 13%;">
                     <a style="color: white;">Người dùng <font color="#808B96">:</font> <?php echo ucfirst($_SESSION['User']['FirstName'])."&nbsp;".ucfirst($_SESSION['User']['LastName']); ?></a> |
                     <a href="../controller/logout.php" style="text-align: right;"> Đăng xuất </a>
                  </div>
         ...
         <div class="box  margin-bottom">
            <div class="margin">
               ...
               <aside class="s-12 l-2">
                  <div class="aside-nav">
                     <ul>
                        <li><a href="home.php" title="Home">Trang chủ</a></li>
                        <li><a href="profile.php" title="Profile">Trang cá nhân</a></li>
                        <li>
                           <a title="Leave">Rời</a>
                           <ul>
                              <li><a href="applyleave.php">Áp dụng</a></li>
                              <li><a href="leavestatus.php">Các yêu cầu đơn</a></li>
                           </ul>
                        </li>
                        <li><a href="changepassword.php" title="Change Password">Mật khẩu</a></li>
                     </ul>
                  </div>
               </aside>
               <!-- CONTENT -->