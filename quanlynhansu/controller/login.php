<?php
	...
	if(isset($_POST['clientlogin']))
	{
		...
		{
			header("location:../user/index.php?msg=Tên người dùng và mật khẩu là bắt buộc");exit;
		}
		else
		{
	...
	else if (isset($_POST['usave']))
	{
		...
		if(empty($old))
		{
			...
			header("location:../user/changepassword.php?msg=Mật khẩu cũ là bắt buộc");exit;
		}
		else
		{
			...
			if(mysqli_num_rows($sql) > 0)
			{
				if(!empty($npass) && !empty($cpass))
				{
					...
					{
						header("location:../user/changepassword.php?msg=Mật khẩu mới và Xác nhận pssword không khớp");exit;
					}
					
				}
				else
				{
					header("location:../user/changepassword.php?msg=Mật khẩu mới và xác nhận mật khẩu là bắt buộc");exit;
				}
			}
			else
			{
				header("location:../user/changepassword.php?msg=Mật khẩu cũ sai!");exit;
			}
		}
	}
	else if (isset($_POST['save']))
	{
		...
		if(empty($old))
		{
			...
			header("location:../changepassword.php?msg=Mật khẩu cũ là bắt buộc");exit;
		}
		else
		{
			...
			if(mysqli_num_rows($sql) > 0)
			{
				if(!empty($npass) && !empty($cpass))
				{
					...
					{
						header("location:../changepassword.php?msg=Mật khẩu mới và Xác nhận pssword không khớp");exit;
					}
				}
				else
				{
					header("location:../changepassword.php?msg=Mật khẩu mới và xác nhận mật khẩu là bắt buộc");exit;
				}
			}
			else
			{
				header("location:../changepassword.php?msg=Mật khẩu cũ sai!");exit;
			}
		}
	}
	else if(isset($_POST['submit']))
	{
		...
		if(empty($Username) || empty($Password))
		{
			...
			header("location:../index.php?msg=Tên người dùng và mật khẩu là bắt buộc");exit;
		}
		else
		{
			...
			{
				header("location:../index.php?msg=Tên người dùng và mật khẩu là sai!");exit;
			}
		}
	}
	...
	function user()
	{
		...
		{
			header("location:../user/index.php?msg=Tên người dùng và mật khẩu là sai!");exit;
		}
	}
?>
