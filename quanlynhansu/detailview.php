...
<ol class="breadcrumb" style="margin: 10px 0px ! important;">
    <li class="breadcrumb-item"><a href="Home.php">Trang chủ</a><i class="fa fa-angle-right"></i>Bảng<i class="fa fa-angle-right"></i>Xem nhân viên<i class="fa fa-angle-right"></i>Xem chi tiết</li>
</ol>
<form method="post">
<div class="validation-form" style="margin-top: 0;">
	...
	<div class="row">
		<div class="col-md-5">
			<table>
				<tbody>
					<tr>
						<td rowspan="2" style="text-align: right;"><b>Ảnh</b>&nbsp;:</td>
		...
		<div class="col-md-4">
			<table>
				<tbody>
					<tr>
						<td style="text-align: right;"><b>Giới tính</b>:</td>
						<td><?php if($gendern) { echo ucfirst($gendern['Name']); } else{ echo "Null"; }?></td>
					</tr>
				</tbody>
				<tbody>
					<tr>
						<td style="text-align: right;"><b>Hôn nhân</b>:</td>
						<td><?php if($maritaln) { echo $maritaln['Name']; } else{ echo "Null"; }?></td>
					</tr>
				</tbody>
				<tbody>
					<tr>
						<td style="text-align: right;"><b>Ngày sinh</b>:</td>
				...
				<tbody>
					<tr>
						<td style="text-align: right;"><b>Số điện thoại</b>:</td>
		...
		<div class="col-md-3">
			<table>
				<tbody>
					<tr>
						<td style="text-align: right;"><b>Phân quyền</b>:</td>
						<td><?php if($rolen) { echo ucfirst($rolen['Name']); } else{ echo "Null"; }?></td>
					</tr>
				</tbody>
				<tbody>
					<tr>
						<td style="text-align: right;"><b>Chức vụ</b>:</td>
						<td><?php if($positionn) { echo $positionn['Name']; } else{ echo "Null"; }?></td>
					</tr>
				</tbody>
				<tbody>
					<tr>
						<td style="text-align: right;"><b>Ngày tham gia</b> ::</td>
						<td><?php if($row) { echo $row['JoinDate']; } else{ echo "Null"; }?></td>
					</tr>
				</tbody>
				<tbody>
					<tr>
						<td style="text-align: right;"><b>Địa chỉ MAC</b> ::</td>
	...
	<div class="row" style="text-align: center; margin-top: 2%;">
		<div class="col-md-12 form-group">
            ...
            <button type="submit" name="delete" class="btn btn-default">Xóa</button>
            <button type="submit" name="close" class="btn btn-primary">Đóng</button>
        </div>
	</div>
</div>
</form>
